...
class Strings
{
     ...
     */
    public static function setSlugify(SlugifyInterface $slugify)
    {
     ...
     */
    public static function getSlugify(): SlugifyInterface
    {
        if (empty(self::$slugify)) {
            self::setSlugify(new Slugify());
        }
    ...
    {
        return self::getSlugify()->slugify($string, $separator);
    }
     ...
     * @return string
     */
    public static function escape($string, bool $stripTags = false): string
    {
